          ...
          <div style={{ backgroundColor: '#ffffff', border: '1px solid #e2e8f0', borderRadius: '20px', padding: '1.5rem', boxShadow: '0 4px 20px rgba(0,0,0,0.03)' }}>
            ...
            {buyersLoading ? (
              ...
              <PotentialBuyersCard buyers={potentialBuyers.length > 0 ? potentialBuyers : [
                { id: 1, business_name: 'AgriTrade Foods', verification_status: 'verified', location: 'Kolkata, West Bengal', commodities: 'Potato, Onion', buying_capacity: '10,000 kg', show_contact_publicly: true, phone: '+91 98765 43210' },
                { id: 2, business_name: 'GreenHarvest Ltd', verification_status: 'website_verified', location: 'Howrah, West Bengal', commodities: 'Potato, Vegetables', buying_capacity: '5,000 kg', show_contact_publicly: true, phone: '+91 98765 11223' },
                { id: 3, business_name: 'FreshMart Traders', verification_status: 'unverified', location: 'Kolkata, West Bengal', commodities: 'Potato, Tomato', buying_capacity: '3,000 kg', show_contact_publicly: false }
              ]} />
            )}
          </div>
        </div>
