      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            borderRadius: '10px',
            backgroundColor: activeTab === 'mandi_prices' ? '#0b3d2e' : '#f4f8f5',
            color: activeTab === 'mandi_prices' ? '#ffffff' : '#475569',
            fontWeight: 700,
            fontSize: '0.9rem',
            border: activeTab === 'mandi_prices' ? '1px solid #0b3d2e' : '1px solid #d6e4db',
            cursor: 'pointer',
        ...
        <button
          ...
          style={{
            padding: '0.65rem 1.25rem',
            borderRadius: '10px',
            backgroundColor: activeTab === 'enam_info' ? '#0b3d2e' : '#f4f8f5',
            color: activeTab === 'enam_info' ? '#ffffff' : '#475569',
            fontWeight: 700,
            fontSize: '0.9rem',
            border: activeTab === 'enam_info' ? '1px solid #0b3d2e' : '1px solid #d6e4db',
            cursor: 'pointer',
            transition: 'all 0.2s ease',
            flex: 1,
            minWidth: '200px'
